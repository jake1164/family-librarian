...
namespace FamilyLibrarian.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260922162030_AddAdminInspectionUriToRequestReviewCandidates")]
    partial class AddAdminInspectionUriToRequestReviewCandidates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FamilyLibrarian.Domain.Communications.MatrixSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<int>("AccessTokenFormatVersion")
                        .HasColumnType("integer")
                        .HasColumnName("access_token_format_version");

                    b.Property<DateTimeOffset?>("AccessTokenSetAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("access_token_set_at_utc");
                    ...
                    b.ToTable("matrix_settings", "communications");
                });
            ...
            modelBuilder.Entity("FamilyLibrarian.Domain.Communications.UserMatrixDestination", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<DateTimeOffset?>("VerificationRequestedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("verification_requested_at_utc");
                    ...
                    b.HasIndex("RoomId")
                        .IsUnique()
                        .HasFilter("room_id IS NOT NULL");

                    b.HasIndex("UserId")
                        .IsUnique();

                    b.ToTable("user_matrix_destinations", "communications");
                });
            ...
            modelBuilder.Entity("FamilyLibrarian.Domain.Requests.RequestReviewCandidate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("RequestFormatId");

                    b.HasIndex("RequestId", "DisplayOrder");

                    b.ToTable("request_review_candidates", "requests");
                });
