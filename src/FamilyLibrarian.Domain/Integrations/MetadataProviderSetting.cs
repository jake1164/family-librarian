namespace FamilyLibrarian.Domain.Integrations;

/// <summary>
/// Administrator-managed state for one installed metadata provider.
/// </summary>
/// <remarks>
...
{
    private MetadataProviderSetting()
    {
    }

    public MetadataProviderSetting(string providerId, DateTimeOffset createdAtUtc)
    {
